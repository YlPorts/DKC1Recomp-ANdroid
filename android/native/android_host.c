/* DKC1Recomp Android frontend, v0.1.0-dev.
...
__attribute__((visibility("default"))) int SDL_main(int argc,char **argv) {
  ...
  fprintf(stderr,"\n[start] android-0.1.0-dev base=cb4dae77 arm64 aspect=%s\n",aspect?aspect:"4:3");
  ...
  Dkc1VideoSetAspect(aspect&&!strcmp(aspect,"16:9")?kDkc1VideoAspect16x9:
  ...
  s_snapshot=Dkc1VideoGetAspect()==kDkc1VideoAspect16x9?"quicksave-16x9.state":
