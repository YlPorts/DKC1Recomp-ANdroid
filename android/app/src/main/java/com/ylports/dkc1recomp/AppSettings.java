...
public final class AppSettings {
    public static final String[] ASPECTS={"4:3","16:10","16:9","21:9"};
    ...
    public int aspectIndex(){return get("aspect",0,0,3);}
    public String aspect(){return ASPECTS[aspectIndex()];}
    public String aspectKey(){return aspect().replace(':','x');}
    ...
    public File autoState(Context c){return new File(gameDirectory(c),"autosave-"+aspectKey()+".state");}
    public File slotState(Context c,int slot){return new File(gameDirectory(c),"quicksave-"+aspectKey()+(slot==0?"":"-slot"+(slot+1))+".state");}
}
