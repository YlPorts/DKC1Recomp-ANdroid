...
cmake -S . -B $BuildDir -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded -DSNESRECOMP_SDL_BACKEND=SDL2
...
Write-Host "Built $BuildDir/DKC1Recomp.exe (keep SDL2.dll alongside it)."
